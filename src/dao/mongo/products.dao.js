...
export default class ProductsDao{
    ...
    async getProducts(req,res){
        try{
            ...
            let prevLink = results.hasPrevPage ? `http://localhost:3000/productos/?page=${+page-1}&limit=${limit}&query=${query}&sort=${sort}` : null
            let nextLink = results.hasNextPage ? `http://localhost:3000/productos/?page=${+page+1}&limit=${limit}&query=${query}&sort=${sort}` : null
